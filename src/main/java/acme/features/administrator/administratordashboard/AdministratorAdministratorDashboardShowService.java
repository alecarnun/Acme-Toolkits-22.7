...
@Service
public class AdministratorAdministratorDashboardShowService
		implements AbstractShowService<Administrator, AdministratorDashboard> {
	...
	public AdministratorDashboard findOne(final Request<AdministratorDashboard> request) {
		...
		// TODO The day of the exam rename numberOfTools to numberOfComponents if needed
		final Double ratioChimpums = numberOfTools > 0 ? numberOfChimpum * 100.0 / numberOfTools : null;
	...
	public void unbind(final Request<AdministratorDashboard> request, final AdministratorDashboard entity,
		...
		request.unbind(entity, model, "numberOfProposedPatronages", "numberOfAcceptedPatronages",
				...
				"statsBudgetofDeniedPatronages", "numberOfTools", "statsRetailPriceOfTools", "numberOfComponents",
				"statsRetailPriceOfComponents", "ratioOfChimpums", "statsChimpums");
	...
	private List<AdministratorDashboardChimpum> getStatisticsChimpum() {
		...
		final List<String> currencies = Arrays.asList(this.repository.findAllAcceptedCurrencies().split(","));
